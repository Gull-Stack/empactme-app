...
export const roadmapData: Phase[] = [
  {
    ...
    tasks: [
      ...
      { id: "1a-3", name: "Organization Access Control", status: "planned", description: "Companies authorize specific employees (e.g. 2 of 100). Role-based permissions for pickup, delivery, admin access" },
      { id: "1a-4", name: "Deep Profile System", status: "planned", description: "Name, age, interests, sports teams, preferences — feeds into matching & rewards" },
      { id: "1a-4b", name: "Stripe Connect Payment Integration", status: "planned", description: "Bank account connection, escrow, commission splits" },
      { id: "1a-5", name: "Opportunity Category Browser", status: "done", description: "Transportation, Products, Celebrity, NIL, Vendor — each with sub-categories and drill-down" },
      { id: "1a-5b", name: "Campaign Filtering & Sorting", status: "planned", description: "Filter by product, type, request. Sort by timeline, status, completion date" },
